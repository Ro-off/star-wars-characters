...
<template>
  <div class="fixed top-0 h-full w-full z-10 bottom-0 flex justify-center items-end">
    <div
      class="blur-progressive-bottom h-10/12 w-full fixed bottom-0 -z-10 bg-gradient-to-t from-black to-transparent"
    />
    <main class="text-gray-100 px-4 py-12 overflow-hidden mt-10">
